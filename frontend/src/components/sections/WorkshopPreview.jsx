        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {data.slice(0, 4).map(w => (
            <div key={w.id} className="bg-white rounded-fabric p-4 border-stitch-warm card-hover-fabric">
              <div className="aspect-[4/3] bg-warmth-100 rounded-fabric-sm mb-3 flex items-center justify-center overflow-hidden">
                <span className="text-ink-400 text-xs">[Workshop Photo]</span>
              </div>
